...
function RecommendedHotels() {
    ...
    const filterHotels = ()=>{
        const cleanCities = searchedCities
        .flat()
        .filter(Boolean)
        ...
        cleanCities.includes(room.hotel.city));
  ...
  return recommended.length > 0 &&  (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24
        ...
        <Title title='Recommended Hotels' subTitle='Discover our handpicked selection of exceptional properties around
        the world, offering unparalled luxury and unforgettable experiences.'  />
